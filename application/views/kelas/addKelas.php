    ...
    <div class="col-md-10">
      ...
      <form action="<?= base_url('kelas/addKelas') ?>" method="post">
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" name="nama_kelas" class="form-control" id="kelas" required>
          </div>
        </div>
        <div class="row mb-3">
          <label for="kompetensi_keahlian" class="col-sm-2 col-form-label">Kompetensi Keahlian</label>
          <div class="col-sm-10">
            <input type="text" name="kompetensi_keahlian" class="form-control" id="kompetensi_keahlian" required>
          </div>
        </div>
        <div class="row mb-3">
          <div class="col-sm-6">
