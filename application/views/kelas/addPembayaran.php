...
<div class="container-fluid pt-4 px-4">
  <div class="bg-light rounded p-4">
    <div class="col-md-10">
      ...
      <form action="<?= base_url('pembayaran/addPembayaran') ?>" method="post">
        <div class="row mb-3">
        ...
        <div class="row mb-3">
          <div class="col-sm-6">
            ...
            <a href="<?= base_url('pembayaran') ?>" class="btn btn-sm btn-secondary">Cancel</a>
          </div>
        </div>
      </form>
      <!-- End Form Tambah Data Pembayaran -->
    </div>
  </div>
</div>
<!-- Pembayaran End -->